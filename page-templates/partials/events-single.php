...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="entry-content">
		...
		<div class="gallery">
		<?php 
			$gallery_images = get_field('event_gallery'); 
			...
			{
				echo "<img class='event-gallery-image' src='".$image['url']."'/>";
			}
		?>
		</div>
		...
		<div class="client">
		<?php echo get_field('event_client'); ?>
		</div>

		<div class="materials">
		<?php echo get_field('event_materials'); ?>
		</div>
	...
	<footer class="entry-footer">
		<?php austeve_events_entry_footer(); ?>
	</footer><!-- .entry-footer -->
</article><!-- #post-## -->
